...
const IngredientItem = React.memo(function ListItem({item, onMainButtonPress, onPress, added}) {
  let handleViewRef;
  return (
        ...
        <TouchableOpacity 
            ...
            <Layout style={styles.container}>
                ...
                <Text appearance='hint' category='c2'>
                    Used in {item.Popularity == 0? 1: item.Popularity} {item.Popularity < 2? 'recipe': "recipes"} 
                </Text>
                </Layout>
